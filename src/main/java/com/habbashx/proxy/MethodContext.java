...
public class MethodContext {
    ...
    public MethodContext(String url, String method, String body,
                         String[] headers, Object[] args, Method reflectionMethod) {
        this.url              = url;
        this.method           = method;
        this.body             = body;
    ...
    public static class MethodContextBuilder {
        ...
        public MethodContextBuilder headers(String[] headers) { this.headers = headers; return this; }

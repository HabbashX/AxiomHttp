package com.habbashx.axiomhttp.request.registry;
 ...
 * from {@link RequestMethod}. {@link HttpExecutor} calls this class
...
public class RequestRegistry {
     ...
     */
    public ResponseContext execute(HttpMethod method, String url, String body, Map<String,List<String>> headers) throws Exception {
     ...
     * @throws IllegalArgumentException if no strategy is registered for {@code method}
     */
    public CompletableFuture<ResponseContext> executeAsync(HttpMethod method, String url, String body,Map<String,List<String>> headers) {
     ...
     */
    private RequestMethod assemble(HttpMethod method, String url, String body,Map<String,List<String>> headers) {

package com.habbashx.axiomhttp.json.serializer;

import com.fasterxml.jackson.databind.JavaType;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.habbashx.axiomhttp.exception.JsonException;
...
public class JacksonSerializer implements JsonSerializer {
    ...
    public static String toPrettyCode(String rawInput) {
        try {
            ObjectMapper mapper = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT);
            String cleanInput = rawInput.trim();

            if (cleanInput.startsWith("\"") && cleanInput.endsWith("\"")) {
                cleanInput = mapper.readValue(cleanInput, String.class);
            }

            Object jsonObject = mapper.readValue(cleanInput, Object.class);
